<div class="section-body">
    <div class="card">
        <div class="card-body">
            ...
            <form method="POST" action="<?php echo base_url('admin/pengajuan/cari_baru') ?>">
                <div class="row">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-6">
                        <a href="<?= base_url('admin/pengajuan/baru') ?>" class="btn btn-primary btn-block"><i class="fas fa-exit"></i> Reset Data</a>
                    </div>
                </div>
